...
export const User1Page: React.FC = (props) => {
  ...
  async function transcode(name: string, type?: string, fileName?: string) {
    ...
    await ffmpeg.current.run('-i', name, '-an', 'origin.mp4'); //demo only
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div className={styles.grid}>
          <h1 className={styles.title}>Hello User1</h1>
        </div>
        <div className={styles.grid}>
          <VideoOutput
            video={video}
        ...
        <div className={styles.card}>
          <div className={styles.button}>
            <Button
              ...
              variant="contained"
            >
              Remove the Sound of Origin Video and Render
            </Button>
          </div>
        </div>
      </main>
...
User1Page.displayName = 'User2Page';
